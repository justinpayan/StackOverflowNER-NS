...
sbatch -J test_real_t_so \
        ...
        --time=01:00:00 \
        --gres=gpu:1 \
         ./runtestreal.sh 0.25 6.25e-5 0 "so_t_1 so_t_2 so_t_3 so_t_4 so_t_5" so_data/so_labels $OUTBASE/models/${TIME} ~/Lamolrelease
...
sbatch -J test_ft_t_so \
        ...
        --time=01:00:00 \
        --gres=gpu:1 \
        ./runtest.sh 0.25 0.2 6.25e-5 0 "so_t_1 so_t_2 so_t_3 so_t_4 so_t_5" so_data/so_labels finetune $OUTBASE/models/${TIME} ~/Lamolrelease
