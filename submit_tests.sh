...
#  for seed in {0..9}; do
#    sbatch -J test_gdumb_${k}_${seed} \
#            -e $OUTBASE/logs/${TIME}/test/finetune/lamol_test_gdumb_${k}_${seed}.err \
#            -o $OUTBASE/logs/${TIME}/test/finetune/lamol_test_gdumb_${k}_${seed}.log \
#            --mem=15G \
#            --partition=m40-short \
#            --time=01:00:00 \
#            --gres=gpu:1 \
