...
for C in {1..10..9}; do
  sbatch -J real_so \
          -e $OUTBASE/logs/train/real/lamol_train_${C}.err \
          -o $OUTBASE/logs/train/real/lamol_train_${C}.log \
          --mem=15G \
          --partition=m40-long \
          --time=01-00:00:00 \
          --gres=gpu:1 \
  ...
  sbatch -J ft_so \
          -e $OUTBASE/logs/train/finetune/lamol_train_${C}.err \
          -o $OUTBASE/logs/train/finetune/lamol_train_${C}.log \
          --mem=15G \
          --partition=m40-long \
          --time=01-00:00:00 \
          --gres=gpu:1 \
  ...
  sbatch -J whole_so \
          -e $OUTBASE/logs/train/finetune/lamol_train_whole_so_${C}.err \
          -o $OUTBASE/logs/train/finetune/lamol_train_whole_so_${C}.log \
          --mem=15G \
          --partition=m40-long \
          --time=01-00:00:00 \
          --gres=gpu:1 \
