...
python train.py --data_dir $DATA_DIR \
    ...
    --learning_rate $LR --use_crf --fp32 --min_n_steps 10000 --min_batch_size 50 \
    --add_task_tokens --use_task_in_ner

#    --learning_rate $LR --use_crf --fp32 --add_task_tokens --use_task_in_ner

#    --learning_rate $LR --use_crf --fp32
...
# ./setupandrunexp.sh 0.25 0.2 6.25e-5 0 "so_1 so_2 so_3 so_4 so_5" so_data/so_labels lll /iesl/canvas/jpayan/Lamolrelease/models ~/Lamolrelease